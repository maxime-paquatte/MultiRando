...
var url1 = "http://windows.microsoft.com/en-us/internet-explorer/download-ie";
var url2 = "http://www.google.com/chrome";
var url3 = "http://www.mozilla.com/firefox/";
var url4 = "http://www.apple.com/safari/";
var url5 = "http://www.opera.com/download/";

var imgName1 = "ie";
var imgName2 = "chrome";
var imgName3 = "firefox";
var imgName4 = "safari";
var imgName5 = "opera";
...
_dd.style.border = "2px outset #000";
...
_ico1ds.background = "transparent url('" + imgPath + "browser_" + imgName1 + ".gif') no-repeat scroll left top";
_ico2ds.background = "transparent url('" + imgPath + "browser_" + imgName2 + ".gif') no-repeat scroll left top";
_ico3ds.background = "transparent url('" + imgPath + "browser_" + imgName3 + ".gif') no-repeat scroll left top";
_ico4ds.background = "transparent url('" + imgPath + "browser_" + imgName4 + ".gif') no-repeat scroll left top";
_ico5ds.background = "transparent url('" + imgPath + "browser_" + imgName5 + ".gif') no-repeat scroll left top";
